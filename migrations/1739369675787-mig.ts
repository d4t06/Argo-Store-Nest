...
export class Mig1739369675787 implements MigrationInterface {
    name = 'Mig1739369675787'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`Product_Units\` (\`id\` int NOT NULL AUTO_INCREMENT, \`unit_name\` varchar(255) NOT NULL, \`unit_name_ascii\` varchar(255) NOT NULL, \`conversion_quantity\` int NOT NULL, \`price\` int NOT NULL, \`debt_price\` int NOT NULL, \`product_id\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Products\` (\`id\` int NOT NULL AUTO_INCREMENT, \`product_name\` varchar(255) NOT NULL, \`product_name_ascii\` varchar(255) NOT NULL, \`image_url\` varchar(255) NOT NULL, \`image_path\` varchar(255) NOT NULL, \`stock_price\` int NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`user_id\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`Customers\` (\`id\` int NOT NULL AUTO_INCREMENT, \`customer_name\` varchar(255) NOT NULL, \`customer_name_ascii\` varchar(255) NOT NULL, \`phone_number\` varchar(255) NOT NULL, \`address\` varchar(255) NOT NULL, \`user_id\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
