...
export class Mig1738991622921 implements MigrationInterface {
    name = 'Mig1738991622921'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`Customers\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`phone_number\` int NOT NULL, \`address\` varchar(255) NOT NULL, \`user_id\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Invoice_Item_Quantities\` (\`id\` int NOT NULL AUTO_INCREMENT, \`price\` int NOT NULL, \`quantity\` int NOT NULL, \`unit_name\` varchar(255) NOT NULL, \`invoice_item_id\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Product_Units\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`conversion_quantity\` int NOT NULL, \`price\` int NOT NULL, \`debt_price\` int NOT NULL, \`product_id\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Products\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`image_url\` varchar(255) NOT NULL, \`image_path\` varchar(255) NOT NULL, \`stock_price\` int NOT NULL, \`price\` int NOT NULL, \`debt_price\` varchar(255) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`user_id\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Invoice_Items\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`invoice_id\` int NOT NULL, \`product_id\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`Users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`phone_number\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`refresh_token\` varchar(255) NOT NULL DEFAULT '', \`role\` varchar(255) NOT NULL DEFAULT 'USER', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`Invoice_Item_Quantities\` ADD CONSTRAINT \`FK_38e499bf2233f6905855f8cf332\` FOREIGN KEY (\`invoice_item_id\`) REFERENCES \`Invoice_Items\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`Invoice_Items\` ADD CONSTRAINT \`FK_e6134bb9677ea986a0ab4839d3c\` FOREIGN KEY (\`product_id\`) REFERENCES \`Products\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Invoice_Item_Quantities\` DROP FOREIGN KEY \`FK_38e499bf2233f6905855f8cf332\``);
        ...
        await queryRunner.query(`DROP TABLE \`Invoice_Item_Quantities\``);
